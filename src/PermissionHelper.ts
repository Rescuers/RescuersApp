...
// Function to check if GOOGLE MAPS is installed or not
const isGoogleMapsInstalled = () => {
    let url = Platform.OS === 'ios' ? "comgooglemaps://" : "https://maps.google.com/" ;
...
export { PermissionsHelper, isGoogleMapsInstalled };
